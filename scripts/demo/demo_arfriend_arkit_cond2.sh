...
python demo_arfriend_arkit_cond1.py \
    --cfg configs/diffusion/arfriend_arkit_cond2/diffspeaker_wav2vec2_arfriend_arkit_cond2.yaml \
    ...
    --checkpoint experiments/arfriend_arkit_cond1/diffusion_bias_arkit_cond1/diffspeaker_wav2vec2_arfriend_arkit_cond2/checkpoints/epoch=${EPOCH_NUMBER}.ckpt \
    --id 003Alan
