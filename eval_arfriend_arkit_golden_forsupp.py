...
LIPACC_MODEL_CKPT = '/home/leoho/diffspeaker/experiments/lipacc_arkit/diffusion_bias_arkit/diffspeaker_wav2vec2_lipacc_arkit_fine_tune_fixid_no_face_loss/checkpoints/epoch=3434.ckpt'
EVAL_LIST = '/data3/leoho/arfriend-diffspeaker/supp_list_2.txt'
WAV_PATH = '/data3/leoho/arfriend-diffspeaker/wav'
PRED_PATH = '/data6/leoho/arfriend-diffspeaker-ext/evals/supp-set-2'
...
speaker_to_id = {
    ...
    "003Alan": 2,
    "005Richard": 3,
    "006Vasilisa": 5, # switch 006Vasilisa to predict 007Jessica
    "007Jessica": 5,
    "008Kunio": 6
}
date_subjects = {
...
def main():
    ...
    # golden inference tweak
    state_dict_copy = {}
    for key in state_dict.keys():
        if "transformer_decoder" not in key:
            state_dict_copy[key] = state_dict[key]
    
    lipacc_state_dict = torch.load(LIPACC_MODEL_CKPT, map_location="cpu")["state_dict"]
    for key in lipacc_state_dict.keys():
        if "transformer_decoder" in key:
            state_dict_copy[key] = lipacc_state_dict[key]
