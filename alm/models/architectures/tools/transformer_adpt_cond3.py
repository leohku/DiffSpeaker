...
class TransformerDecoderLayer_w_Adapter(nn.TransformerDecoderLayer):
    ...
    def forward(self, 
        ...
        if self.norm_first:
            ...
            x = x + self._mha_block(self.norm3(x), memory_cond, memory_mask, memory_key_padding_mask, adapter=adapter)
            ...
            x = self.norm3(x + self._mha_block(x, memory_cond, memory_mask, memory_key_padding_mask, adapter=adapter))
