...
class Adpt_Bias_Denoiser_Cond1(nn.Module):
    ...
    def __init__(self,
        ...
        # audio condition decoder
        self.audio_cond_transformer_decoder = TransformerDecoder_w_Adapter(
            decoder_layer=decoder_layer,
            num_layers=num_layers,
        )
        
        # vertice condition decoder
        self.vertice_cond_transformer_decoder = TransformerDecoder_w_Adapter(
            decoder_layer=decoder_layer,
            num_layers=num_layers,
        )
